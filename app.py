...
# ---------------------------------------------------------------- Applications
    ...
    if df.empty:
        ...
        if app_ids:
            ...
            record = db.get_application(selected_id)
            ...
            with st.form("edit_form"):
                ...
                if submitted:
                    db.update_application(selected_id, {
                ...
                if deleted:
                    db.delete_application(selected_id)
                    st.success("Deleted.")
                    st.rerun()
...
# ---------------------------------------------------------------- Follow-ups
    ...
    if apps:
        with st.form("followup_form", clear_on_submit=True):
            ...
            if submitted:
                db.add_follow_up(app_choice["id"], str(follow_date), description)
    ...
    follow_ups = db.get_follow_ups(include_completed=False)
    if not follow_ups:
...
# ---------------------------------------------------------------- Interviews
    ...
    if apps:
        with st.form("interview_form", clear_on_submit=True):
            ...
            if submitted:
                db.add_interview(app_choice["id"], round_type, str(interview_date), notes, outcome)
